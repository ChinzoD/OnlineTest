                                                    ...
                                                    <div class="portlet-title">
                                                        ...
                                                        <div class="actions">
                                                         <jsp:useBean id="now" class="java.util.Date"/> 
                                                           <button id ="exportResult" class="btn btn-circlebtn-icon-only  btn-default">Export
				                                           </button>
			...
			<tbody>
				<c:forEach items="${reports}" var="report" varStatus="status">
					<tr>
						...
						<td>${report.key.studentId.firstName} ${report.key.studentId.lastName} </td>
