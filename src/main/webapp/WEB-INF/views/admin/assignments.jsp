...
<div id="assignment" class="portlet light ">
	<div class="portlet-title">
		<div class="caption">
			<span class="caption-subject bold uppercase font-dark">Assignment List  </span>
					...
					<tr>
						...
						<td class="noExl" ><c:choose>
								...
								<c:when
									...
									<a
										href="<spring:url value="/result/${assignment.id}" />">result</a> | <a
										href="<spring:url value="/resultDetail/${assignment.id}" />">detail</a>
                                      | <a href="<spring:url value="/resultDetail/${assignment.id}" />">Feedback</a>
